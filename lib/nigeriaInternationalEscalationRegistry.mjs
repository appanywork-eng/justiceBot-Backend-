...
export const NHRC_FINAL_DOMESTIC_ESCALATION =
  authority({
    ...
    channels: {
      ...
      complaint_guidance:
        "https://www.nhrc.gov.ng/about/nhrc-mandate.html",

      contact_page:
        "https://www.nhrc.gov.ng/contact-us.html",
    },
...
export const FRANCE_EMBASSY_NIGERIA_ADVOCACY =
  authority({
    key:
    ...
    aliases: [
      ...
      "France diplomatic mission Nigeria",
    ],
    ...
    address:
      "European Union Crescent, off Constitution Avenue, Central Business District, Abuja, Nigeria",

    website:
      "https://ng.ambafrance.org/",

    channels: {
      official_directory:
        "https://www.diplomatie.gouv.fr/fr/services/annuaire-et-contacts/representations-francaises/ambassade-de-france-au-nigeria/",
    },
    ...
    sourceUrls: [
      "https://www.diplomatie.gouv.fr/fr/services/annuaire-et-contacts/representations-fran%C3%A7aises/ambassade-de-france-au-nigeria/",
      "https://ng.ambafrance.org/",
    ],
  });

export const INEC_ELECTION_INCIDENT_REPORTING =
  authority({
    key:
    ...
    address:
      "Plot 436 Zambezi Crescent, Maitama District, FCT, Abuja, Nigeria",

    website:
      "https://inecnigeria.org/",

    channels: {
      incident_reporting_and_contact:
        "https://inecnigeria.org/contact-us/",
    },
