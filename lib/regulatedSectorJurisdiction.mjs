...
export function resolveAviationRouting(
  ...
  if (
    ...
    return {
      ...
      routingNote:
        "Accidents and serious incidents should be reported to NSIB without delay. Where there is an active emergency, contact emergency services immediately before completing any written report.",
      sourceUrls:
        NSIB_AVIATION_SAFETY
          .verification
          .source_urls,
