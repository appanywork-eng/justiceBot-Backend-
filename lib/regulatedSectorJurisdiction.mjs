...
export function resolveBankingRouting(
  ...
  if (!escalated) {
    ...
    if (!providerRecord) {
      return {
        ...
        routingNote:
          "Confirm the institution's complaint channel through its official website, app or branch. Do not use a guessed email address, and retain the complaint reference and supporting evidence.",
      };
    }
    ...
    return {
      ...
      routingNote:
        providerRecord
          ...
          : "Submit through the institution's official branch, app, website or support channel. No direct email is exposed because one has not been independently verified.",
    };
  }
  ...
  return {
    ...
    routingNote:
      "Escalate after first lodging the complaint with the financial institution. Include its complaint reference, transaction evidence and proof of the earlier complaint.",
  };
}
