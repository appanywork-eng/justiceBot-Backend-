...
import {
  resolveInsuranceRouting,
  resolvePensionRouting,
  resolveUrbanPlanningRouting,
} from "./additionalSectorJurisdiction.mjs";
...
registerJurisdictionResolver(
  ...
  {
    status: "active",
    scope: "PenCom contributory-pension and PTAD defined-benefit complaint routing",
    version: "1.0.0",
    requiresVerifiedData: true,
  }
);
...
registerJurisdictionResolver(
  ...
  {
    status: "active",
    scope: "NAICOM-regulated insurance policy, premium and claim complaints, excluding NHIA health insurance",
    version: "1.0.0",
    requiresVerifiedData: true,
  }
);
...
registerJurisdictionResolver(
  ...
  {
    status: "active",
    scope: "FCT, Lagos and safe state/local development-control and building-control routing",
    version: "1.0.0",
    requiresVerifiedData: true,
  }
);
