...
} from "./healthComplaintEligibility.mjs";
...
function verifiedAuthorityMetadata(
  ...
  return {
    ...
    submissionUrl:
      ...
      contact.falsified_product_portal ||
      contact.reporting_portal ||
      contact.complaint_form ||
      contact.contact_page ||
      contact.complaint_guide ||
      contact.enrollee_charter ||
...
const HEALTH_REGULATOR_TERMS = [
  ...NIGERIAN_HEALTH_AUTHORITIES.flatMap(
    authority => [
      authority.name,
      ...(authority.aliases || []),
    ]
...
function healthAuthorityDecision({
  authority,
  provider = "",
  routeKey,
  caseType,
...
function healthProviderDecision({
  provider,
  routeKey,
  purpose,
  note,
...
export function resolveHealthRouting(
  ...
  const patientDetentionOverBill =
    includesAny(text, ["detained", "detention", "held"]) &&
    includesAny(text, ["patient", "hospital", "clinic"]) &&
    includesAny(text, ["hospital bill", "medical bill", "treatment bill", "unpaid bill"]);

  const emergencyCareDenial =
    includesAny(text, ["emergency treatment", "emergency care"]) &&
    includesAny(text, ["refused", "denied", "withheld"]);

  const seriousRightsIssue =
    patientDetentionOverBill ||
    emergencyCareDenial ||
    includesAny(
      text,
      [
  ...
  const doctorMisconduct =
    includesAny(
      ...
      [
        ...
        "wrong diagnosis",
        "unethical doctor",
        "professional misconduct by doctor",
      ]
    );
  ...
  const nursingMisconduct =
    includesAny(
      ...
      [
        ...
        "nursing misconduct",
        "midwife misconduct",
        "midwifery misconduct",
        "unlicensed nurse",
        "unregistered nurse",
        "unlicensed midwife",
        "unregistered midwife",
        "professional misconduct by nurse",
        "professional misconduct by midwife",
        "nurse acted negligently",
        "midwife acted negligently",
      ]
    );


  const pharmacyMisconduct =
    includesAny(
      text,
      [
        ...
        "unregistered pharmacist",
        "unlicensed pharmacy",
        "illegal pharmacy",
        "pharmacy operating illegally",
  ...
  const laboratoryMisconduct =
    includesAny(
      text,
      [
        "laboratory scientist misconduct",
        "medical laboratory misconduct",
        "unlicensed laboratory scientist",
        "unregistered laboratory scientist",
        "unlicensed laboratory",
        "illegal medical laboratory",
        "falsified laboratory result",
        "falsified lab result",
        "manipulated laboratory result",
        "manipulated lab result",
  ...
  /*
   * Serious health-rights cases bypass ordinary
   * provider-first consumer escalation.
   */
  if (seriousRightsIssue) {
    return healthAuthorityDecision({
      authority:
        NHRC_HEALTH_RIGHTS,
      ...
      purpose:
        "Human-rights complaint arising from healthcare treatment, detention or denial of care",
  ...
  /*
   * Unsafe, falsified or unregistered medical products
   * route directly to NAFDAC.
   */
  if (unsafeMedicalProduct) {
    return healthAuthorityDecision({
      authority:
        NAFDAC_MEDICAL_PRODUCT_SAFETY,
      ...
      caseType:
        "medical_product_safety",

      jurisdiction:
        "national_medical_product_regulator",

      purpose:
        "Report of a suspected substandard, falsified, unsafe or unregistered medical product",

      note:
        "Provide the product name, batch or registration details, place of purchase, photographs, packaging, receipts and any adverse-reaction information.",
    });
  }
  ...
  /*
   * PETITIONDESK_SPECIALIST_HEALTH_PRIORITY_V1
   *
   * Professional-discipline and unsafe-product complaints
   * must be resolved before MDCN's general medical route
   * and before the generic healthcare-provider fallback.
   */

  const unsafeMedicalProductIssue =
    includesAny(
      text,
      [
        "counterfeit drug",
        ...
        "unsafe medicine",
        "adverse drug reaction",
        "harmful medical product",
        "defective medical product",
      ]
    );

  const pharmacyProfessionalIssue =
    includesAny(
      text,
      [
        "pharmacist",
  ...
  const nursingProfessionalIssue =
    includesAny(
      text,
      [
        "nurse",
  ...
  const laboratoryProfessionalIdentity =
    includesAny(
      text,
      [
  ...
  const laboratoryResultMisconductIssue =
    includesAny(
      text,
      [
        "misconduct",
  ...
  const laboratoryProfessionalIssue =
    laboratoryProfessionalIdentity &&
    laboratoryResultMisconductIssue;

  if (unsafeMedicalProductIssue) {
    return {
      matched: true,
      ...
      jurisdiction:
        "national_medical_product_regulation",

      routeKey:
        "nafdac_medical_product_report",

      primaryInstitution:
        NAFDAC_MEDICAL_PRODUCT_SAFETY.name,
      ...
      documentPurpose:
        "Report concerning a suspected unsafe, counterfeit, falsified, expired or harmful medical product",

      routingNote:
        "Provide the product name, batch number, manufacturer, place of purchase, purchase date, photographs, receipt and details of any injury or adverse reaction.",
    };
  }

  if (pharmacyProfessionalIssue) {
    return {
      matched: true,
      ...
      jurisdiction:
        "pharmacy_professional_discipline",

      routeKey:
        "pcn_pharmacy_complaint",

      primaryInstitution:
        PCN_PHARMACY_DISCIPLINE.name,
      ...
      documentPurpose:
        "Professional misconduct complaint involving a pharmacist or pharmacy practice",

      routingNote:
        "Identify the pharmacist or pharmacy, describe the dispensing or professional error, and attach the prescription, medicine packaging, receipt and supporting medical evidence.",
    };
  }

  if (nursingProfessionalIssue) {
    return {
      matched: true,
      ...
      jurisdiction:
        "nursing_and_midwifery_discipline",

      routeKey:
        "nmcn_nursing_complaint",

      primaryInstitution:
        NMCN_NURSING_DISCIPLINE.name,
      ...
      documentPurpose:
        "Professional misconduct complaint involving a nurse or midwife",

      routingNote:
        "Identify the nurse or midwife, healthcare institution, incident date, treatment involved, witnesses, records and resulting harm.",
    };
  }

  if (laboratoryProfessionalIssue) {
    return {
      matched: true,
      ...
      jurisdiction:
        "medical_laboratory_discipline",

      routeKey:
        "mlscn_laboratory_complaint",

      primaryInstitution:
        MLSCN_LABORATORY_DISCIPLINE.name,
      ...
      documentPurpose:
        "Professional misconduct complaint involving medical laboratory practice",

      routingNote:
        "Identify the laboratory and practitioner, state the test performed, explain the suspected falsification or error, and attach the request form, result, receipt and any independent repeat result.",
    };
  }
  ...
  if (
    ...
    return healthAuthorityDecision({
      ...
      note:
        quackPractice
          ? "Provide the suspect's identity, address, incident location and supporting evidence through MDCN's official quack-reporting process."
          : "Provide clear particulars, relevant medical documents and the verifying affidavit requested by MDCN's official complaint process.",
    });
  }


  if (nursingMisconduct) {
    return healthAuthorityDecision({
      authority:
        NMCN_NURSING_DISCIPLINE,
      ...
      jurisdiction:
        "nursing_and_midwifery_professional_discipline",

      purpose:
        "Professional misconduct complaint concerning a nurse or midwife",

      note:
        "Identify the nurse or midwife where known and provide the facility, incident date, treatment record, witnesses and supporting documents.",
    });
  }


  if (pharmacyMisconduct) {
    return healthAuthorityDecision({
      authority:
        PCN_PHARMACY_DISCIPLINE,
      ...
      jurisdiction:
        "pharmacy_professional_and_premises_regulation",

      purpose:
        "Complaint concerning pharmacy practice, a pharmacist or an unlicensed pharmacy premises",

      note:
        "Provide the pharmacy or practitioner's identity, medicine dispensed, prescription, receipt, incident date and supporting evidence.",
    });
  }


  if (laboratoryMisconduct) {
    return healthAuthorityDecision({
      authority:
        MLSCN_LABORATORY_DISCIPLINE,
      ...
      jurisdiction:
        "medical_laboratory_professional_discipline",

      purpose:
        "Complaint concerning medical laboratory practice, a laboratory scientist or an unlicensed laboratory",

      note:
        "Provide the laboratory's identity, test request, result, dates, receipts and any evidence supporting the alleged misconduct.",
    });
  }
   ...
   * HMO/provider first, then NHIA after evidence.
   */
  if (insuranceIssue) {
    if (
      !escalated &&
    ...
    if (
      ...
      return healthProviderDecision({
        ...
        purpose:
          "Follow-up to the HMO or healthcare provider before NHIA escalation",

        note:
          "NHIA escalation is not yet ready because evidence of the earlier HMO or provider complaint is missing. Follow up through the official provider channel and retain the complaint reference, acknowledgement or correspondence.",
  ...
  /*
   * Ordinary hospital or healthcare-service complaint:
   * provider first, then FCCPC after evidence.
   */
  if (provider) {
    if (!escalated) {
      return healthProviderDecision({
    ...
    if (
      ...
      return healthProviderDecision({
        ...
        purpose:
          "Follow-up to the healthcare provider before consumer-protection escalation",

        note:
          "Consumer escalation is not yet ready because evidence of the earlier provider complaint is missing. Follow up through the provider's official management or patient-relations channel and retain the acknowledgement, correspondence or reference.",
    ...
    return healthAuthorityDecision({
      ...
      note:
        "Use this route for unresolved billing, service or consumer-treatment complaints that do not primarily concern professional discipline, medical-product safety, human rights or health-insurance regulation.",
