...
} from "./nigeriaVerifiedBankingChannels.mjs";
...
const BASE_NIGERIAN_BANKING_PROVIDERS =
  Object.freeze([
    ACCESS_BANK,
    ...
    provider({
      ...
      aliases: [
        ...
        "Veend HQ",
        "Veend",
        "VeendHQ Remita Payroll Loan",
        "Veend Remita Payroll Loan",
      ],
...
export const NIGERIAN_BANKING_PROVIDERS =
  Object.freeze(
    BASE_NIGERIAN_BANKING_PROVIDERS.map(
      item => {
        const channel =
          VERIFIED_BANKING_CHANNELS[
            item.key
